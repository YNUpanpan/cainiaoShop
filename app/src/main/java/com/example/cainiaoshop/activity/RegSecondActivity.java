...
import com.example.cainiaoshop.utils.CountTimerView;
...
//        dialog = new SpotsDialog(this,"正在校验验证码");
        ...
        dialog = (SpotsDialog) new SpotsDialog.Builder().setContext(RegSecondActivity.this).setCancelable(false).build();
        dialog = (SpotsDialog) new SpotsDialog.Builder().setContext(RegSecondActivity.this).setMessage("loading....").setCancelable(false).build();
